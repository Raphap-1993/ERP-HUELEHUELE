...
| Fase 1 - Analisis y requerimientos | Backfilled para el slice inicial | `docs/fase-1-analisis-requerimientos/` |
| Fase 2 - UX/UI | Backfilled para el slice inicial | `docs/fase-2-ux-ui/`, `specs/001-checkout-payments/product-design.md`, `specs/001-checkout-payments/spdd-frontend.md` |
| Fase 3 - Arquitectura | Backfilled para el slice inicial | `docs/fase-3-arquitectura/` |
| Fase 4 - SDD | Instanciada para la primera feature | `docs/fase-4-sdd/`, `specs/001-checkout-payments/` |
...
- La capa canonica actual cubre bien el slice inicial, pero no todo el monorepo.
- La narrativa metodologica ya existe para `checkout/payments`; falta replicarla al resto del producto vivo.

## Proximos pasos
1. Revisar y aprobar la capa canonica intermedia del slice `checkout/payments`.
