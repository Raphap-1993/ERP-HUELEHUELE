      ...
      <div className="mx-auto max-w-[1120px] px-4 md:px-6">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {BENEFITS.map((b) => (
            ...
            >
              <div className="absolute inset-x-0 top-0 h-0.5 origin-left scale-x-0 bg-gradient-to-r from-[#52b788] to-[#c9a84c] transition-transform duration-300 group-hover:scale-x-100" />
              <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#d8f3dc] text-2xl">
                {b.icon}
              </div>
              ...
              <p className="text-xs font-semibold text-[#52b788]">{b.kw}</p>
            </div>
          ))}
        </div>
      </div>
