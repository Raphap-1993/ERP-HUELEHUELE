...
| Slices canonicos brownfield ya homologados | `docs/fase-1-analisis-requerimientos/`, `docs/fase-2-ux-ui/`, `docs/fase-3-arquitectura/`, `docs/fase-4-sdd/`, `specs/` (`001` a `015`) |
