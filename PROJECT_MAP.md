...
| `docs/fase-1-analisis-requerimientos/` | RF, casos de uso y reglas canonicas del slice inicial. |
| `docs/fase-2-ux-ui/` | UX canonica del slice visual homologado. |
| `docs/fase-3-arquitectura/` | Arquitectura, decisiones y ADRs canonicos. |
| `docs/fase-4-sdd/` | Puente metodologico hacia `specs/` por feature. |
| `docs/fase-5-construccion/` a `docs/fase-8-operacion/` | Backfill canonico de construccion, QA, deploy y operacion. |
| `specs/001-checkout-payments/` | Primera feature canonica del brownfield. |
...
| Slice canonico de checkout/pagos | `docs/fase-1-analisis-requerimientos/`, `docs/fase-2-ux-ui/`, `docs/fase-3-arquitectura/`, `specs/001-checkout-payments/` |
