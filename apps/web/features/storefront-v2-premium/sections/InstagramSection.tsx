    ...
    <section className="bg-white py-20">
      <div className="mx-auto max-w-[1120px] px-4 text-center md:px-6">
        ...
        <Link
          ...
          target="_blank"
          rel="noreferrer"
          className="mb-10 inline-flex items-center gap-3 font-serif text-2xl font-black text-[#1a3a2e] transition hover:text-[#52b788] md:text-3xl"
        >
