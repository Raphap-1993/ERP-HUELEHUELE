...
| `docs/fase-1-analisis-requerimientos/` | RF, casos de uso y reglas canonicas de los slices brownfield ya homologados. |
| `docs/fase-2-ux-ui/` | UX canonica de las superficies brownfield homologadas. |
| `docs/fase-3-arquitectura/` | Arquitectura, decisiones y ADRs canonicos de los slices abiertos. |
| `docs/fase-4-sdd/` | Puente metodologico hacia `specs/` por feature brownfield homologada. |
...
| `specs/` | Features canonicas por slice brownfield homologado (`001` a `004` en este corte). |
