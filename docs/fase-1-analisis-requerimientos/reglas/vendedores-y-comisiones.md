...
- no se permite correccion si existe `payoutId` no cancelado, job de payout pendiente/en ejecucion o reversa/cancelacion con impacto financiero cerrado
...
- no existe flujo canonico post-lock dentro de este slice
