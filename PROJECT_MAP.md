...
| `docs/fase-1-analisis-requerimientos/` | RF, casos de uso y reglas canonicas de los slices brownfield homologados `001` a `014`. |
| `docs/fase-2-ux-ui/` | UX canonica de las superficies brownfield homologadas `001` a `014`. |
| `docs/fase-3-arquitectura/` | Arquitectura, decisiones y ADRs canonicos de los slices abiertos `001` a `014`. |
| `docs/fase-4-sdd/` | Puente metodologico hacia `specs/` por feature brownfield homologada `001` a `014`. |
...
| `specs/` | Features canonicas por slice brownfield homologado (`001` a `014` en este corte). |
...
| Slices canonicos brownfield ya homologados | `docs/fase-1-analisis-requerimientos/`, `docs/fase-2-ux-ui/`, `docs/fase-3-arquitectura/`, `docs/fase-4-sdd/`, `specs/` (`001` a `014`) |
